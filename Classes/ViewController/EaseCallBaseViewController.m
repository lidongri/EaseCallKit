...
- (void)viewDidLoad {
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(counselorAudioEndClick) name:@"BWHomeCounselorAudioEndNotify" object:nil];
}

-(void)counselorAudioEndClick
{
    [self hangupAction];
}
